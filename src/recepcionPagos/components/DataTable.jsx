...
import { showThunk, deleteThunk, getAllThunks } from '../../store/recepcionPagosStore/recepcionPagosThunks';
...
export function DataTable() {
  ...
  const { recepcionesPagos } = useSelector(state => state.recepcionPagosStore);
  console.log("=== recepcionesPagos ===", recepcionesPagos);
  ...
  return (
    <Box sx={{ height: '100vh', width: '100%' }}>
      ...
      <DataGrid
      rows={recepcionesPagos?.results || []}
      columns={columns}
      paginationMode="server"
      rowCount={recepcionesPagos?.count || 0} // total de registros desde el backend
