...
import { showThunk, deleteThunk, getAllThunks } from '../../store/tarjetasBancariasStore/tarjetasBancariasStoreThunks';
...
export function DataTable() {
  ...
  const columns = [
    ...
    { field: 'pan_ultimos_4',         headerName: 'Numero de cuenta',     width: 200 },
