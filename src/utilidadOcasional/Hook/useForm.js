...
import { handleFormStoreThunk, resetFormularioThunk } from "../../store/utilidadOcasionalStore/utilidadOcasionalThunks";
...
export const useForm = (dataStore) => {
  ...
  const { idUtilidadOcasional, tarjeta_id, valor, descripcion } = dataStore;
