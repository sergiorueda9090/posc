...
import { showThunk, deleteThunk, getAllThunks } from '../../store/clienteStore/clienteThunks';
...
export function DataTable() {
  ...
  return (
    <Box sx={{ height: '100vh', width: '100%' }}>
      ...
      <DataGrid
      rows={clientes?.results || []}
      columns={columns}
      paginationMode="server"
      rowCount={clientes?.count || 0} // total de registros desde el backend
