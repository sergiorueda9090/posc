...
import { createThunks, updateThunks } from "../../store/gastoStore/gastoThunks";
...
export const FormDialogModal = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const isEdit = Boolean(formValues.idGasto);
    ...
    if (isEdit) {
      dispatch(updateThunks({ id: formValues.idGasto, ...data }));
    } else {
