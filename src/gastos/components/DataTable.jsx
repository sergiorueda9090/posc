...
import { showThunk, deleteThunk, getAllThunks } from '../../store/gastoStore/gastoThunks';
...
export function DataTable() {
  ...
  const { gastos } = useSelector(state => state.gastoStore);
  ...
  return (
    <Box sx={{ height: '100vh', width: '100%' }}>
      ...
      rowCount={gastos?.count || 0} // total de registros desde el backend
