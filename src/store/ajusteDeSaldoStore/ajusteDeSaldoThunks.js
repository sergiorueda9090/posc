...
import { showStore, listStore, resetFormularioStore, handleFormStore } from "./ajusteDeSaldoStore.js";

import { URL } from "../../constants/constantGlogal.js";
const namespace_api      = "/api/ajustessaldo/";
const endpoint           = "list/";
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.status === 200) {
        const ajustesDeSaldo = response.data;
        await dispatch(listStore({ ajustesDeSaldo }));
      } else {
          ...
          try {
            ...
            if(response.status == 200){
                ...
                await dispatch(showStore(
                                            { idAjusteDeSaldo         : response.data.id ?? '',
