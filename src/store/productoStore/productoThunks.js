...
import { showStore, listStore, resetFormularioStore, handleFormStore } from "./productoStore.js";

import { URL } from "../../constants/constantGlogal.js";
const namespace_api      = "/api/products/";
const endpoint           = "list/";
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        await dispatch(listStore({ productos: productos }));
      } else {
        console.error("⚠️ Error al obtener productos:", response);
      }
    } catch (error) {
        ...
        const options = {
          ...
          try {
            ...
            if(response.status == 200){
                ...
                await dispatch(showStore({ producto: response.data}));
