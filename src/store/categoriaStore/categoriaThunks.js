...
import { showStore, listStore, resetFormularioStore, handleFormStore } from "./categoriaStore.js";

import { URL } from "../../constants/constantGlogal.js";
const namespace_api      = "/api/categories/";
const endpoint           = "list/";
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        await dispatch(listStore({ categorias: categorias }));
      } else {
