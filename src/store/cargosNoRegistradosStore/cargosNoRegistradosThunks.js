...
import { showStore, listStore, resetFormularioStore, handleFormStore } from "./cargosNoRegistradosStore.js";

import { URL } from "../../constants/constantGlogal.js";
const namespace_api      = "/api/cargosnoregistrados/";
const endpoint           = "list/";
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.status === 200) {
        const cargosNoRegistrados = response.data;
        await dispatch(listStore({ cargosNoRegistrados }));
      } else {
          ...
          try {
            ...
            if(response.status == 200){
                ...
                await dispatch(showStore(
                                            { idCargosNoRegistrados   : response.data.id ?? '',
