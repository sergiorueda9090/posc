...
import { showStore, listStore, resetFormularioStore, handleFormStore } from "./gastoStore.js";

import { URL } from "../../constants/constantGlogal.js";
const namespace_api      = "/api/gastos/";
const endpoint           = "list/master/";
const endpoint_delete    = "/master/delete/";
const endpoint_create    = "create/master/";
const endpoint_update    = "master/update/";
...
export const showThunk= (id = "") => {
    ...
    return async (dispatch, getState) => {
        ...
        const options = {
            method: 'GET',
            url: `${ URL}${namespace_api}${id}/master/`,
            headers: {
              Authorization: `Bearer ${token}`
            }
          };
