...
import { showStore, listStore, resetFormularioStore, handleFormStore } from "./recepcionPagosStore.js";

import { URL } from "../../constants/constantGlogal.js";
const namespace_api      = "/api/recepcionpago/";
const endpoint           = "list/";
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.status === 200) {
        const recepcionesPagos = response.data;
        await dispatch(listStore({ recepcionesPagos }));
      } else {
          ...
          try {
            ...
            if(response.status == 200){
                ...
                await dispatch(showStore(
                                            { idRecepcionPago         : response.data.id ?? '',
