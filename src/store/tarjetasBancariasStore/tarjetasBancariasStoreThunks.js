...
import { showStore, listStore, resetFormularioStore, handleFormStore } from "./tarjetasBancariasStore.js";

import { URL } from "../../constants/constantGlogal.js";
const namespace_api      = "/api/cards/";
const endpoint           = "list/";
            ...
            if(response.status == 200){
                ...
                await dispatch(showStore(
                                            { idTarjeta         : response.data.id ?? '',
                                              pan               : response.data.pan_ultimos_4 ?? '',
