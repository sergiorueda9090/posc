...
import { showThunk, deleteThunk, getAllThunks } from '../../store/categoriaStore/categoriaThunks';
...
export function DataTable() {
  ...
  return (
    <Box sx={{ height: '100vh', width: '100%' }}>
      ...
      <DataGrid
      rows={categorias?.results || []}
      columns={columns}
      paginationMode="server"
      rowCount={categorias?.count || 0} // total de registros desde el backend
