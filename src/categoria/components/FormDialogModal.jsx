...
import { createThunks, updateThunks } from "../../store/categoriaStore/categoriaThunks";
...
export const FormDialogModal = () => {
  ...
  const categoriaStore       = useSelector((state) => state.categoriaStore);
  ...
  const handleSubmit = (event) => {
    ...
    const isEdit = Boolean(formValues.idCategoria);
    ...
    if (isEdit) {
      dispatch(updateThunks({ id: formValues.idCategoria, ...data }));
    } else {
