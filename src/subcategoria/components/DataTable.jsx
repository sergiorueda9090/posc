...
import { showThunk, deleteThunk, getAllThunks } from '../../store/subcategoriaStore/subcategoriaThunks';
...
export function DataTable() {
  ...
  const columns = [
    ...
    { field: 'nombre',                headerName: 'Subcategoria',         width: 180 },
    { field: 'descripcion',           headerName: 'Descripción',          width: 250 },
    { field: 'creado_por',            headerName: 'Creado por',           width: 180 },
    {
      field: 'created_at',
  ...
  return (
    <Box sx={{ height: '100vh', width: '100%' }}>
      ...
      <DataGrid
      rows={subcategorias?.results || []}
      columns={columns}
      paginationMode="server"
      rowCount={subcategorias?.count || 0} // total de registros desde el backend
