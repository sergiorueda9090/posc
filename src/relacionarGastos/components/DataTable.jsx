...
import { showThunk, deleteThunk, getAllThunks } from '../../store/relacionarGastoStore/relacionarGastoThunks';
...
export function DataTable() {
  ...
  const { relacionGastos } = useSelector(state => state.relacionarGastoStore);
  ...
  const columns = [
    ...
    { field: 'tipo_gasto',            headerName: 'Gasto',                width: 180 },
    { field: 'total_gasto',           headerName: 'Total Gasto',          width: 250,      
      renderCell: (params) => {
    ...
    { field: 'descripcion_registro',  headerName: 'Descripción',          width: 250 },
  ...
  return (
    <Box sx={{ height: '100vh', width: '100%' }}>
      ...
      <DataGrid
      rows={relacionGastos?.results || []}
      columns={columns}
      paginationMode="server"
      rowCount={relacionGastos?.count || 0} // total de registros desde el backend
