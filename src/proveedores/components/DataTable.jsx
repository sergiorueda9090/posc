...
import { showThunk, deleteThunk, getAllThunks } from '../../store/proveedoresStore/proveedoresThunks';
...
export function DataTable() {
  ...
  const columns = [
    ...
    { field: 'nombre_empresa',     headerName: 'Nombre Empresa',   width: 200 },
    /*{ field: 'descripcion',        headerName: 'Descripción',      width: 200 },
    { field: 'ciudad',             headerName: 'Ciudad',           width: 180 },*/

    /*{ field: 'email',        headerName: 'Email',       width: 180 },
    { field: 'contacto_principal',        headerName: 'Contacto principal',       width: 180 },
  ...
  return (
    <Box sx={{ height: '100vh', width: '100%' }}>
      ...
      rowCount={proveedores?.count || 0} // total de registros desde el backend
